class ControladorContenido {
  ...
  inicializar() {
    this.cargarVistaHomePorDefecto();
    this.inicializarEventos();
  }

  /**
   * Carga la vista Home por defecto al inicializar la aplicación
   */
  async cargarVistaHomePorDefecto() {
    try {
      await this.cargarVista('home');
    } catch (error) {
      console.error(
        'ControladorContenido: Error al cargar vista Home por defecto:',
        error
      );
    }
  }
